...
int main(int argc, char const * argv[])
{
    {
        test_type x;
        aurae::detail::weak_store sx = aurae::detail::weak_store(&x);
    ...
    }
    {
        ...
        aurae::detail::weak_store sx = aurae::detail::weak_store(std::weak_ptr<test_type>(x));
        BOOST_TEST(sx.lockable());
    ...
    }
    {
        ...
        aurae::detail::weak_store sx = aurae::detail::weak_store(std::weak_ptr<test_type const>(x));
        BOOST_TEST(sx.lockable());
        BOOST_TEST_EQ(sx.maybe_lock<void const>(), x);
        BOOST_TEST(!sx.maybe_lock<void>());
        BOOST_TEST_EQ(sx.maybe_lock<test_type const>(), x);
